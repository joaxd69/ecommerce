...
export class AccesoriesProductsComponent {
  Title:string="Accesorios"
  Products:ProductsApi[]=[]
  TotalProducts:string|number=0
  ProductsR:ProductsApi[]=[]
  Section:string='Accesories'
  ProductType:string='Accesories'
  ...
  traerinfo(){///traemos info del back end
    ...
    if(!myQueryParam){
    this.ProductsService. getSomeProducts(ProductType.Accesories).//accedemos al metodo que hace una peticion a la ruta que nos da los celulares
